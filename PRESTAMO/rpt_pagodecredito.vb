...
Public Class rpt_pagodecredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRESTAMO.rpt_pagodecredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_var() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_pagodecredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_pagodecredito = New rpt_pagodecredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
