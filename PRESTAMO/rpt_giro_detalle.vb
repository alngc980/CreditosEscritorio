...
Public Class rpt_giro_detalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRESTAMO.rpt_giro_detalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_giro_detalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_giro_detalle = New rpt_giro_detalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
