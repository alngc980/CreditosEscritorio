...
Public Class rpt_pagos_ingresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRESTAMO.rpt_pagos_ingresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_pagos_ingresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_pagos_ingresos = New rpt_pagos_ingresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
