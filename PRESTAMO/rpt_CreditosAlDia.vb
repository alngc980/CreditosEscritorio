...
Public Class rpt_CreditosAlDia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PRESTAMO.rpt_CreditosAlDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_CreditosAlDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CreditosAlDia = New rpt_CreditosAlDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
